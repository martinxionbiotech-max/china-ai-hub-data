...
|---|---|---|---|---|---|
| qwen3.8-max | 2.0 | 6.0 | 0.25 | Beijing and Global regions (HK/Frankfurt/US/Tokyo): $1.65 input / $4.951 output. Beijing batch: 50% off. Explicit cache creation $2.5, explicit cache read $0.17 (Singapore). Free quota: 1M tokens, 90 days (Singapore). | https://www.alibabacloud.com/help/en/model-studio/model-pricing |
| qwen3.8-flash | 0.15 | 0.47 | 0.016 | Beijing and Global regions: $0.113 / $0.382. Explicit cache creation $0.2, read $0.016 (Singapore). Batch inference not supported. | https://www.alibabacloud.com/help/en/model-studio/model-pricing |
