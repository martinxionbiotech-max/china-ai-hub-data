...
Billed via MiniMax Token Plan subscriptions: Plus $22/mo, Max $55/mo, Ultra $132/mo (5-hour rolling + weekly quota windows); credits 1,000 = $1 for overflow. API pay-as-you-go also available for enterprises.
